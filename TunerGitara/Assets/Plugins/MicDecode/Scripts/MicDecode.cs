...
namespace JulianSchoenbaechler.MicDecode
{
	...
	public class MicDecode : MonoBehaviour
	{
		...
		//события для определения струны
		public delegate void NoteFreqencyDetection(float freqency );
		public static event NoteFreqencyDetection notePlayed;
